        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-10">
            ...
            <div className="bg-white rounded-3xl p-6 shadow-sm border border-gray-200 flex items-center gap-5">
              ...
              <div>
                ...
                <p className="text-4xl font-semibold mt-1">{activeCardsCount}</p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-3xl p-6 shadow-sm border border-gray-200 flex items-center gap-5">
              ...
              <div>
                ...
                <p className="text-4xl font-semibold mt-1">{pendingApplications}</p>
              </div>
            </div>
          ...
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8">
            <div>
              ...
              <p className="text-gray-600 mt-1">Manage your physical and virtual cards</p>
            </div>
          ...
          {myCards.length > 0 ? (
            ...
            <div className="text-center py-20 bg-white rounded-3xl border border-gray-200">
              ...
              <p className="mt-4 text-gray-500">You don’t have any cards yet</p>
            </div>
          )}

          {/* Quick Apply Section */}
          <div className="bg-white rounded-3xl p-8 shadow-sm border border-gray-200">
            <h2 className="text-2xl font-semibold mb-2">Apply for a New Card</h2>
            <p className="text-gray-600 mb-8">Instant virtual card or physical card delivery</p>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div 
                onClick={() => { setCardType('Virtual'); setShowApplyModal(true); }}
                className="border-2 border-dashed border-gray-300 hover:border-blue-500 rounded-3xl p-8 text-center cursor-pointer transition-all hover:shadow-md"
              >
                <div className="mx-auto w-16 h-16 bg-blue-100 rounded-2xl flex items-center justify-center mb-4">
                  <CreditCard className="w-9 h-9 text-blue-600" />
                </div>
                <h3 className="font-semibold text-xl">Virtual Card</h3>
                <p className="text-gray-500 mt-2 text-sm">Instant • For online use • No shipping</p>
              </div>
              ...
              >
                ...
                <h3 className="font-semibold text-xl">Physical Card</h3>
                <p className="text-gray-500 mt-2 text-sm">Delivered to your address • 5-7 days</p>
              </div>
            </div>
          </div>
        </div>
      ...
      {showApplyModal && (
        <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-3xl max-w-md w-full p-8">
            <h2 className="text-2xl font-semibold mb-6">Apply for {cardType} Card</h2>

            <div className="space-y-6">
              <div>
                <label className="text-sm text-gray-600 block mb-2">Card Type</label>
                <div className="bg-gray-100 px-4 py-3 rounded-2xl font-medium">{cardType} Card</div>
              </div>

              <div>
                <label className="text-sm text-gray-600 block mb-2">Daily Limit</label>
                <input 
                  type="text" 
                  defaultValue="$5,000" 
                  className="w-full bg-gray-100 border border-gray-200 rounded-2xl px-4 py-3 focus:outline-none focus:border-blue-500"
                />
              </div>

              <div>
                <label className="text-sm text-gray-600 block mb-2">Purpose (Optional)</label>
                <textarea 
                  className="w-full bg-gray-100 border border-gray-200 rounded-2xl px-4 py-3 h-24 resize-y focus:outline-none focus:border-blue-500"
